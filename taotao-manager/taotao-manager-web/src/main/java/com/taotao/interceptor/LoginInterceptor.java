...
public class LoginInterceptor implements HandlerInterceptor
{
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception
    {
        ...
        if (null == user)
        {
            ...
            //response.sendRedirect(userService.getSSOBaseUrl() + userService.getSSOPageLogin() + "?redirect=" + request.getRequestURL());

            ResponseInstruction<String> result = new ResponseInstruction<String>(ResponseStatus.SESSIONLOST, "用户未登录！");
